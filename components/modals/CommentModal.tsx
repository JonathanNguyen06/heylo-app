...
export default function CommentModal() {
  ...
  return (
    <>
      ...
      >
        <div
          className="w-full h-full bg-white sm:w-[600px] sm:h-fit
          sm:rounded-xl outline:none focus:outline-none relative
        "
        >
          <XMarkIcon
          ...
          />
          <div className="pt-5 pb-10 flex flex-col px-0 sm:px-5">
            <PostHeader
